...
uniprot_fasta_file = f'{huvec_config.REFERENCE_DIRECTORY}/uniprot_reviewed_canonical_and_isoform.fasta'
# PSM file locations
gencode_psm_file = f'{huvec_config.PIPELINE_RESULTS_DIRECTORY}/metamorpheus/gencode/search_results/Task1SearchTask/AllPSMs.psmtsv'
uniprot_psm_file = f'{huvec_config.PIPELINE_RESULTS_DIRECTORY}/metamorpheus/uniprot/search_results/Task1SearchTask/AllPSMs.psmtsv'
pacbio_filtered_psm_file = f'{huvec_config.PIPELINE_RESULTS_DIRECTORY}/metamorpheus/pacbio/filtered/search_results/Task1SearchTask/AllPSMs.psmtsv'
pacbio_hybrid_psm_file = f'{huvec_config.PIPELINE_RESULTS_DIRECTORY}/metamorpheus/pacbio/hybrid/search_results/Task1SearchTask/AllPSMs.psmtsv'
# Peptide file locations
gencode_peptide_file = f'{huvec_config.PIPELINE_RESULTS_DIRECTORY}/metamorpheus/gencode/search_results/Task1SearchTask/AllPeptides.Gencode.psmtsv'
uniprot_peptide_file = f'{huvec_config.PIPELINE_RESULTS_DIRECTORY}/metamorpheus/uniprot/search_results/Task1SearchTask/AllPeptides.UniProt.psmtsv'
pacbio_filtered_peptide_file = f'{huvec_config.PIPELINE_RESULTS_DIRECTORY}//metamorpheus/pacbio/filtered/search_results/Task1SearchTask/AllPeptides.{sample_name}.filtered.psmtsv'
pacbio_hybrid_peptide_file = f'{huvec_config.PIPELINE_RESULTS_DIRECTORY}//metamorpheus/pacbio/hybrid/search_results/Task1SearchTask/AllPeptides.{sample_name}.hybrid.psmtsv'
# Protein group file locations
gencode_protein_group_file = f'{huvec_config.PIPELINE_RESULTS_DIRECTORY}/metamorpheus/gencode/search_results/Task1SearchTask/AllQuantifiedProteinGroups.Gencode.tsv'
uniprot_protein_group_file = f'{huvec_config.PIPELINE_RESULTS_DIRECTORY}/metamorpheus/uniprot/search_results/Task1SearchTask/AllQuantifiedProteinGroups.UniProt.tsv'
pacbio_filtered_protein_group_file = f'{huvec_config.PIPELINE_RESULTS_DIRECTORY}/metamorpheus/pacbio/filtered/search_results/Task1SearchTask/AllQuantifiedProteinGroups.{sample_name}.filtered.tsv'
pacbio_hybrid_protein_group_file = f'{huvec_config.PIPELINE_RESULTS_DIRECTORY}/metamorpheus/pacbio/hybrid/search_results/Task1SearchTask/AllQuantifiedProteinGroups.{sample_name}.hybrid.tsv'
pacbio_rescue_resolve_protein_group_file = f'{huvec_config.PIPELINE_RESULTS_DIRECTORY}/metamorpheus/pacbio/rescue_resolve/search_results/Task1SearchTask/AllQuantifiedProteinGroups.{sample_name}.rescue_resolve.tsv'
high_confidence_file = f'{huvec_config.PIPELINE_RESULTS_DIRECTORY}/hybrid_protein_database/{sample_name}_refined_high_confidence.tsv'
high_confidence_genes_file = f'{huvec_config.PIPELINE_RESULTS_DIRECTORY}/hybrid_protein_database/huvec_high_confidence_genes.tsv'
